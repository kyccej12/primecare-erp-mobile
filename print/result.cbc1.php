...
<table width=80% cellpadding=0 cellspacing=5 align=center>
    ...
    <tr>
        ...
        <td align=center style="border-bottom: 1px solid black;">'. $b['mcv'] . ' fL</td>
    ...
    <tr>
        ...
        <td align=center style="border-bottom: 1px solid black;">'. $b['mch'] . ' g/dL</td>
    ...
    <tr>
        ...
        <td align=center style="border-bottom: 1px solid black;">'. $b['mchc'] . ' g/dL</td>
    ...
    <tr>
        ...
        <td align=center style="border-bottom: 1px solid black;">'. ROUND($b['neutrophils']) . '%</td>
    ...
    <tr>
        ...
        <td align=center style="border-bottom: 1px solid black;">'. ROUND($b['lymphocytes']) . '%</td>
    ...
    <tr>
        ...
        <td align=center style="border-bottom: 1px solid black;">'. ROUND($b['monocytes']) . '%</td>
    ...
    <tr>
        ...
        <td align=center style="border-bottom: 1px solid black;">'. ROUND($b['eosinophils']) . '%</td>
    ...
    <tr>
        ...
        <td align=center style="border-bottom: 1px solid black;">'. ROUND($b['basophils']) . '%</td>
