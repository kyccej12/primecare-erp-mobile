...
/* MYSQL QUERIES SECTION */
    ...
    $b = $con->getArray("SELECT dengue_ag,dengue_igg,dengue_igm,verified_by,verified FROM lab_dengue WHERE so_no = '$_REQUEST[so_no]' and branch = '$_SESSION[branchid]' and serialno = '$_REQUEST[serialno]';");
