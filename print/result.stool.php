...
/* MYSQL QUERIES SECTION */
    ...
    $b = $con->getArray("SELECT *,date_format(result_date,'%m/%d/%Y') as rdate FROM lab_stoolexam WHERE serialno = '$_ihead[serialno]';");
    if($b['verified_by'] != '') {
...
<table width=100% cellpadding=2 cellspacing=0 style="font-size: 9px;margin-top:20px;">
    ...
    <tr>
        <td width="100%" colspan=4 style="padding-top: 15px;" align=center>
         <span style="font-weight: bold; font-size: 12pt; color: #000000;">FECALYSIS REPORT (SE)</span>
        </td>
    </tr>
</table>
