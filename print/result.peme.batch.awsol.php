<?php
	...
	$outerQuery = $con->dbquery("SELECT DISTINCT a.pid, CONCAT(b.lname,' ,',b.fname,' ,',b.mname) AS pname, b.employer FROM peme a LEFT JOIN pccmain.patient_info b ON a.pid = b.patient_id WHERE so_no = '6' AND a.examined_by > 0 AND b.employer = 'Advanced World Solutions, Inc.' ORDER BY b.lname DESC, b.fname, b.mname;");
