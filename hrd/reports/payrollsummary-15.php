...
<tbody>';
	...
	while($drow = $a->fetch_array()) {
		...
		$b = $pay->dbquery("select * from emp_payslip where period_id = '$cutoff' and emp_type = '$_SESSION[payclass]' and register_exclude != 'Y' and dept = '$drow[dept]' and `area` = '$drow[area]' order by emp_name;");
