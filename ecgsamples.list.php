...
<script>
	...
	$(document).ready(function() {
		var myTable = $('#itemlist').DataTable({
			...
			"aoColumnDefs": [
			    ...
			    { "targets": [0,12,13,14,15], "visible": false }
            ]
		});
		...
		$('#itemlist tbody').on('dblclick', 'tr', function () {
			...
			if(data['ostat'] == '1') { msg = "It appears you have to attach a \"PDF\" file to associate with this result..."; }
			...
			if(msg != '') {
				...
				parent.writeECGResult(data['id'],data['code']);
			}
	...
	function printResult() {
		...
		if(!lid) {
			parent.sendErrorMessage("Please select a record to print...");
		} else {
